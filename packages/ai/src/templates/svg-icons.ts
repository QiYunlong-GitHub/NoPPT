...
const FILLED_ICONS: Record<string, string> = {
  target:
    '<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 16a6 6 0 1 1 0-12 6 6 0 0 1 0 12zm0-9a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/>',
  ...
  terminal:
    '<path d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm1.3 4.3a1 1 0 0 0-1.4 1.4L5.6 11l-2.7 2.3a1 1 0 1 0 1.4 1.4l3.5-3a1 1 0 0 0 0-1.4l-3.5-3zM12 16h6a1 1 0 0 0 0-2h-6a1 1 0 0 0 0 2z"/>',
  ...
  server:
    '<path d="M4 5a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v3a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V5zm12 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zM4 14a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v3a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3v-3zm12 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>',
  database:
    '<path d="M12 2C7 2 3 3.3 3 5v14c0 1.7 4 3 9 3s9-1.3 9-3V5c0-1.7-4-3-9-3zm0 13c-4.4 0-7-1.2-7-2.5V10c1.6 1 4.1 1.5 7 1.5s5.4-.5 7-1.5v2.5c0 1.3-2.6 2.5-7 2.5z"/>',
  cloud: '<path d="M18 10h-1.3A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/>',
  rocket:
    '<path d="M12 1.2c-2.8 1.9-5.5 6.2-6 12.3l-3.3 3.3c-.4.4-.4 1 0 1.4l1.4 1.4c.4.4 1 .4 1.4 0L9 16.5c2.7.5 7.4-.7 10.8-4.2 2.4-2.4 3-5.5 2.7-9.6-3.3-.3-7.2.3-9.6 2.7L12 1.2zM14.5 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zM6.7 18.3l-3 3c-.4.4-1 .4-1.4 0l-.3-.3 3-3 1.7.3z"/>',
  zap: '<path d="M13 2L3 14h7l-1 8 10-12h-7l1-8z"/>',
  shield:
    '<path d="M12 2l8 3v7c0 5.5-3.8 9.4-8 10-4.2-.6-8-4.5-8-10V5l8-3zm-1.3 13.7l5-5-1.4-1.4-3.6 3.6-1.6-1.6L7.7 13l3 3z"/>',
  'shield-check':
    '<path d="M12 2l8 3v7c0 5.5-3.8 9.4-8 10-4.2-.6-8-4.5-8-10V5l8-3zm-1.3 13.7l5-5-1.4-1.4-3.6 3.6-1.6-1.6L7.7 13l3 3z"/>',
  ...
  sparkles:
    '<path d="M12 2l2.1 6.4L21 10.5l-6 3L12 20l-3-6.5-6-3 6.9-2.1L12 2zm7.5 2a.5.5 0 0 0-.5.5V6h-1.5a.5.5 0 0 0 0 1H19v1.5a.5.5 0 0 0 1 0V7h1.5a.5.5 0 0 0 0-1H20V4.5a.5.5 0 0 0-.5-.5zM4.5 16a.5.5 0 0 0-.5.5V18H2.5a.5.5 0 0 0 0 1H4v1.5a.5.5 0 0 0 1 0V19h1.5a.5.5 0 0 0 0-1H5v-1.5a.5.5 0 0 0-.5-.5z"/>',
  users:
    '<path d="M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm6 0a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM9 13c-3.3 0-7 1.7-7 5v2h14v-2c0-3.3-3.7-5-7-5zm6.5 0c-.4 0-.8 0-1.2.1 1.6 1.1 2.7 2.8 2.7 4.9v2h6v-2c0-3-2.9-5-7.5-5z"/>',
  'trending-up':
    '<path d="M23 5v6a1 1 0 0 1-1.7.7L19 9.4l-7.3 7.3a1 1 0 0 1-1.4 0L6 12.4l-5.3 5.3a1 1 0 0 1-1.4-1.4l6-6a1 1 0 0 1 1.4 0l4.3 4.3 6.6-6.6-2.3-2.3A1 1 0 0 1 16 4h6a1 1 0 0 1 1 1z"/>',
  'bar-chart-3':
    '<path d="M3 3a1 1 0 0 0-1 1v16a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H3zm13 4a1.5 1.5 0 0 1 1.4.9l1.4 2.9a1.5 1.5 0 0 1-1.3 2.2h-1.9l-1 2.8a1.5 1.5 0 0 1-2.8 0L9.9 12H7.5a1.5 1.5 0 0 1 0-3h3.3l.7-2.1A1.5 1.5 0 0 1 13 6h3z"/>',
  search:
    '<path d="M11 2a9 9 0 1 0 5.3 16.3l4.2 4.2a1 1 0 0 0 1.4-1.4l-4.2-4.2A9 9 0 0 0 11 2zm0 3a6 6 0 1 1 0 12 6 6 0 0 1 0-12z"/>',
  settings:
    '<path d="M19.4 13a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V19a2 2 0 0 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 0 1 0-4h.1a1.7 1.7 0 0 0 1.5-1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 0 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H19a2 2 0 0 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>',
  package:
    '<path d="M12 1 3 6v12l9 5 9-5V6l-9-5zm0 2.2L19 7l-7 4-7-4 7-3.8zM5 8.6l6 3.4v8.8l-6-3.3V8.6zm8 12.2V12l6-3.4v8.9l-6 3.3z"/>',
  layers:
    '<path d="M12 2 2 7l10 5 10-5-10-5zm-9 15 9 4.5L21 17l-8.5 4L3 17zm0-5 9 4.5L21 12l-8.5 4L3 12z"/>',
  globe:
    '<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm6.9 6h-3.1c-.3-1.8-.8-3.5-1.6-5 1.9.7 3.6 2.4 4.7 5zM12 4c1 1.4 1.8 3.4 2.1 6H9.9C10.2 7.4 11 5.4 12 4zM4.3 14c-.2-.6-.3-1.3-.3-2s.1-1.4.3-2h3.4c-.1.7-.1 1.3-.1 2s0 1.3.1 2H4.3zm.8 2h3.1c.3 1.8.8 3.5 1.6 5-1.9-.7-3.6-2.4-4.7-5zM9.9 20c-1-1.4-1.8-3.4-2.1-6h4.2c-.3 2.6-1.1 4.6-2.1 6zm2.1-8H7.7c.1-.7.1-1.3.1-2s0-1.3-.1-2h4.2c.1.7.1 1.3.1 2s0 1.3-.1 2zm0 4h4.2c-.3 2.6-1.1 4.6-2.1 6-1-1.4-1.8-3.4-2.1-6zm2.2-2c.1-.7.1-1.3.1-2s0-1.3-.1-2h3.4c.2.6.3 1.3.3 2s-.1 1.4-.3 2h-3.4z"/>',
  clock:
    '<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 11a1 1 0 0 1-1 1H8a1 1 0 0 1 0-2h4V6a1 1 0 0 1 2 0v6z"/>',
  calendar:
    '<path d="M7 2a1 1 0 0 1 1 1v1h8V3a1 1 0 0 1 2 0v1h1a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1V3a1 1 0 0 1 1-1zm12 8H5v10h14V10z"/>',
  'check-circle':
    '<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm5.7 7.7-6 6a1 1 0 0 1-1.4 0l-3-3a1 1 0 0 1 1.4-1.4L11 13.6l5.3-5.3a1 1 0 0 1 1.4 1.4z"/>',
  'check-circle-2':
    '<path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm5.7 7.7-6 6a1 1 0 0 1-1.4 0l-3-3a1 1 0 0 1 1.4-1.4L11 13.6l5.3-5.3a1 1 0 0 1 1.4 1.4z"/>',
  check:
    '<path d="M20.3 5.3a1 1 0 0 0-1.4 0L9 15.2 5.1 11.3a1 1 0 0 0-1.4 1.4l4.6 4.6a1 1 0 0 0 1.4 0L20.3 8.1a1 1 0 0 0 0-1.4z"/>',
  'alert-triangle':
    '<path d="M12 2L1 21h22L12 2zm0 7a1 1 0 0 1 1 1v4a1 1 0 0 1-2 0v-4a1 1 0 0 1 1-1zm0 8a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>',
  ...
  heart:
    '<path d="M12 21.4 3.6 13a5.5 5.5 0 0 1 7.8-7.8l.6.6.6-.6A5.5 5.5 0 0 1 20.4 13L12 21.4z"/>',
  flag: '<path d="M4 2v20a1 1 0 0 0 2 0v-6c1-.3 2.5-1 5-1 3 0 5 2 9 2V3c-1 0-2.5-1-5-1-3 0-5 2-9 2V2a1 1 0 0 0-2 0z"/>',
  'book-open':
    '<path d="M11 4a1 1 0 0 0-1-1H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h5a1 1 0 0 0 1-1V4zm2 0v16a1 1 0 0 0 1 1h5a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-5a1 1 0 0 0-1 1z"/>',
  ...
  'arrow-right':
    '<path d="M4 11a1 1 0 0 0 0 2h10.6l-3.3 3.3a1 1 0 0 0 1.4 1.4l5-5a1 1 0 0 0 0-1.4l-5-5a1 1 0 1 0-1.4 1.4L14.6 11H4z"/>',
  ...
  trophy:
    '<path d="M6 2h12v7a6 6 0 0 1-12 0V2zm-2 0h2v5H4a2 2 0 0 1 0-4zm14 0h2a2 2 0 0 1 0 4h-2V2zm-7 12a8 8 0 0 0 5-1.7V18h3v2H5v-2h3v-3.7A8 8 0 0 0 11 14z"/>',
  award: '<path d="M12 2a6 6 0 1 0 0 12 6 6 0 0 0 0-12zm-5 14l-1 6 6-3 6 3-1-6a8 8 0 0 1-10 0z"/>',
  wrench:
    '<path d="M22.7 2.3a1 1 0 0 0-1.1-.2c-2.3.9-4.9.4-6.6-1.3-.8-.8-2-.8-2.8 0L3.3 9.7a1 1 0 0 0 0 1.4l4 4-2.3 2.3-2-2a1 1 0 0 0-1.4 1.4l2 2 .3.3 2 2a1 1 0 0 0 1.4-1.4l-2-2 2.3-2.3 4 4a1 1 0 0 0 1.4 0l8.9-8.9c.8-.8.8-2 0-2.8-1.7-1.7-2.3-4.3-1.3-6.6a1 1 0 0 0-.2-1.1z"/>',
  flame:
    '<path d="M12 2c.5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-12.1-4.9c.3.6.9 1 1.6 1 .8 0 1.5-.7 1.5-1.5 0-1.4-.5-2-1-3 0 0 1.5-2.5 3-3.6z"/>',
  palette:
    '<path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c1 0 1.8-.8 1.8-1.8 0-.5-.2-.9-.5-1.2-.3-.3-.5-.7-.5-1.1 0-.9.7-1.6 1.6-1.6h2c3 0 5.6-2.5 5.6-5.5C22 6 17.5 2 12 2zM8 10a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5-2a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm4 3a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>',
  smartphone:
    '<path d="M17 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zm-5 18a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>',
  'message-square': '<path d="M21 3H5a2 2 0 0 0-2 2v16l4-4h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z"/>',
  'git-branch':
    '<path d="M18 3a3 3 0 0 0-1 5.8V10a8 8 0 0 1-8 8h-.2a3 3 0 1 0 0 2H9a10 10 0 0 0 10-10V8.8A3 3 0 0 0 18 3zM6 18a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>',
};
