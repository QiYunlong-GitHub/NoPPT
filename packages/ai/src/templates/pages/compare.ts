...
<div style="${ctx.OUTER};" data-layout="comparison-deep-dive">
  ...
  <div style="flex:1;display:flex;gap:28px;min-height:0;min-width:0;align-items:stretch;">
    ...
    <div style="flex:1;padding:28px 24px;border-radius:16px;background:linear-gradient(135deg,${ctx.P}06,${ctx.P}0A);display:flex;flex-direction:column;gap:16px;min-width:0;min-height:0;box-shadow:0 8px 28px ${ctx.P}18;">
      <h3 style="font-size:28px;font-weight:800;margin:0;text-align:center;padding-bottom:14px;border-bottom:2px solid ${ctx.P}35;overflow-wrap:break-word;word-break:break-word;${ctx.GRAD_H3_CARD}">升级方案 / 优势方案</h3>
      <ul style="margin:0;padding:0;list-style:none;flex:1;min-width:0;display:flex;flex-direction:column;gap:16px;min-height:0;">
        <!-- 右栏第 1 项：advantageIndices 包含（✅ 胜出 → 绿色三件套 + 深渐变）-->
        <li style="display:flex;flex-direction:column;gap:10px;padding:18px 22px;border-radius:14px;background:#FFFFFF;border-left:5px solid #10b981;box-shadow:0 4px 16px ${ctx.P}18;min-width:0;overflow-wrap:break-word;word-break:break-word;">
          <div style="display:flex;align-items:center;gap:12px;">
          ...
          <div style="width:100%;height:12px;border-radius:999px;background:${ctx.P}20;overflow:hidden;">
        ...
        <li style="display:flex;flex-direction:column;gap:10px;padding:18px 22px;border-radius:14px;background:#FFFFFF;border-left:5px solid ${ctx.P};box-shadow:0 4px 16px ${ctx.P}18;min-width:0;overflow-wrap:break-word;word-break:break-word;">
          <div style="display:flex;align-items:center;gap:12px;">
