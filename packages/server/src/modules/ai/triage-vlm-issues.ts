...
const IMAGE_KEYWORDS = [
  '图片模糊', '模糊', '畸变', '畸形', '扭曲', '无关', '不相关', '风格不符', '裁切', '低分辨率',
  '像素', '锯齿', '图片内容', '配图质量', '主体缺失', '画面违和', '图片质量',
  'blurry', 'distorted', 'irrelevant', 'low quality', 'pixelated',
];

const HTML_KEYWORDS = [
  '对齐', '重叠', '溢出', '超出', '裁切文本', '字号', '过小', '过大', '留白', '层级',
  '对比', '配色', '边距', '间距', '错位', '遮挡', '换行', '文字', '排版', '布局',
  'alignment', 'overlap', 'overflow', 'font size', 'spacing', 'layout',
];
