...
export const en: Record<string, string> = {
  ...
  '未配置 NOPPT_ADMIN_KEY，管理接口不可用': 'NOPPT_ADMIN_KEY is not set; management API unavailable',
  ...
  'referenceHtml 超过 2MB 上限，请精简后再提交': 'referenceHtml exceeds the 2MB limit; please trim it and retry',
  'referenceImage 超过大小上限': 'referenceImage exceeds the size limit',
  '参数校验失败：{detail}': 'Validation failed: {detail}',
  '演示 {id} 不存在或不属于当前作用域': 'Presentation {id} does not exist or is outside the current scope',
  ...
  '整份编辑返回 {count} 页，超过 {max} 页上限': 'Edit returned {count} slides, exceeding the limit of {max}',
  ...
  // 草稿读取端点手写错误体
  '草稿不存在或已被清理，请让助手重新生成一条链接': 'The draft does not exist or has been cleared; please ask the assistant to regenerate a link',
  '草稿已过期，请让助手重新生成一条链接': 'The draft has expired; please ask the assistant to regenerate a link',
